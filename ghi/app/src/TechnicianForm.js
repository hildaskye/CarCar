...
//         const technicianUrl = 'http://localhost:8080/api/tecnhicians/';
//         const fetchConfig = {
//             method: "post",
//             body: JSON.stringify(technician),
//             headers: {
...
//                     <form onSubmit={handleSubmit} id="create-technician-form">
//                         <div className="form-floating mb-3">
//                             <input onChange={handleFirstNameChange} placeholder="First Name" value={first_name}
//                                 required type="text" name="first_name" id="first_name" className="form-control"/>
//                                 <label htmlFor="first_name">First Name</label>
//                         </div>
//                         <div className="form-floating mb-3">
//                             <input onChange={handleLastNameChange} placeholder="Last Name" value={last_name}
//                                 required type="text" name="last_name" id="last_name" className="form-control"/>
//                                 <label htmlFor="last_name">Last Name</label>
//                         </div>
//                         <div className="form-floating mb-3">
//                             <input onChange={handleEmployeeIDChange} placeholder="Employee ID" value={employee_id}
//                                 required type="text" name="employee_id" id="employee_id" className="form-control"/>
//                                 <label htmlFor="employee_id">Employee ID</label>
//                         </div>
//                         <button className="btn btn-primary">Create</button>
//                     </form>
